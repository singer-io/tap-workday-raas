...
class WorkdayRaasSync(unittest.TestCase):
    ...
    def get_properties(self):
        return {
            ...
            'reports': json.dumps([{'report_url': 'https://wd2-impl-services1.workday.com/ccx/service/customreport2/talend_dpt1/tserrano/Customer_Invoice_Action_List?format=rss',
